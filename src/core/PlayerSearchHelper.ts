...
export class PlayerSearchHelper<T extends GameData> {
  private players: T[];
  private searchIndex: Map<string, T>;
  ...
  public findPlayer(searchTerm: string): T | null {
  ...
  public getSuggestions(
    ...
    const matches: { player: T; relevance: number }[] = [];
  ...
  public getAllPlayers(): T[] {
    return [...this.players];
  }

  // Obtenir un joueur aléatoire
  public getRandomPlayer(): T {
